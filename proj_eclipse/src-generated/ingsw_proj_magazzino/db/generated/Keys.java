...
public class Keys {
    ...
    public static final UniqueKey<MovimentazioneRecord> MOVIMENTAZIONE__PK_MOVIMENTAZIONE = Internal.createUniqueKey(Movimentazione.MOVIMENTAZIONE, DSL.name("pk_Movimentazione"), new TableField[] { Movimentazione.MOVIMENTAZIONE.ORDINE, Movimentazione.MOVIMENTAZIONE.BOX }, true);
